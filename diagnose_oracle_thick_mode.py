...
def diagnose():
    ...
    print("-" * 80)
    try:
        from gyra_ext.datasource.rdbms.conn_oracle import _init_thick_mode, _find_instant_client_paths
        ...
        if success:
            ...
            print("  3. 未在 gyra.json 中配置 oracle_instant_client_path")
    ...
    print("=" * 80)
    print("""
方案 1：配置 gyra.json（推荐）
--------------------------------
编辑 ~/.gyra/gyra.json，添加：
