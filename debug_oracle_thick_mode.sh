...
echo -e "\n4. 检查配置文件"
echo "----------------------------------------"
CONFIG_FILE="$HOME/.gyra/gyra.json"
...
try:
    from gyra_ext.datasource.rdbms.conn_oracle import (
        _init_thick_mode,
    ...
    # 设置更详细的日志
    logging.getLogger('gyra_ext.datasource.rdbms.conn_oracle').setLevel(logging.DEBUG)
