...
from gyra.vis.vis_converter import VisProtocolConverter, SystemVisTag
from gyra_ext.vis.gyra.tags.drsk_content import DrskContent, DrskTextContent
from gyra_ext.vis.gyra.tags.drsk_msg import DrskMsg, DrskMsgContent
from gyra_ext.vis.gyra.tags.drsk_thinking import DrskThinking, DrskThinkingContent
...
class GyraVisConverter(VisProtocolConverter):
    def __init__(self, paths: Optional[str] = None, **kwargs):
        default_tag_paths = ["gyra_ext.vis.gyra.tags", "gyra_ext.vis.common.tags"]
