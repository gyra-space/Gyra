...
from gyra.agent import ActionOutput, UserProxyAgent
from gyra.agent.core.action.base import AskUserType
from gyra.agent.core.reasoning.reasoning_action import AgentAction
from gyra.agent.core.types import MessageType
from gyra.agent.core.memory.gpts import GptsMessage, GptsPlan
from gyra.vis.schema import (
    VisConfirm,
    VisPlansContent,
    VisTextContent,
    VisTaskContent,
...
from gyra_ext.vis.gyra.ask_user.manager import convert

from gyra_ext.vis.gyra.tags.drsk_content import DrskTextContent, DrskContent
from gyra_ext.vis.gyra.tags.drsk_interact import DrskInteract
from gyra_ext.vis.gyra.tags.drsk_msg import DrskMsgContent
from gyra_ext.vis.gyra.tags.drsk_thinking import DrskThinkingContent, DrskThinking
from gyra_serve.agent.db import GptsMessagesDao

NONE_GOAL_PREFIX: str = "none_goal_count_"
logger = logging.getLogger(__name__)


class GyraVisIncrConverter(GyraVisConverter):
    @property
    ...
    async def gen_message_vis(self, message: GptsMessage) -> str:
        # from gyra.agent import get_agent_manager
        ...
        if thinking:
            thinking_content = DrskThinkingContent(
                ...
                uid=uid + "_thinking",
                type="all",
                think_link=f"{self._gyra_url}/nexa/drsk/thinking/detail?message_id={uid}",
            )
