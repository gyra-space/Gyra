...
from gyra.vis.vis_manus_protocol import (
    ManusStepType,
    ManusStepStatus,
    ManusOutputType,
    ManusArtifactType,
...
from gyra_ext.vis.gyra.tags.drsk_content import DrskContent, DrskTextContent
...
from gyra_ext.vis.gyra.tags.manus_left_panel import ManusLeftPanel
from gyra_ext.vis.gyra.tags.manus_right_panel import ManusRightPanel
from gyra_ext.vis.gyra.tags.drsk_deliverable import DrskDeliverable
...
class GyraIncrVisManusConverter(GyraIncrVisWindow3Converter):
    """Manus 双面板增量可视化布局转换器

    继承自 GyraIncrVisWindow3Converter，复用其 planning_window 逻辑，
            ...
            for action_out in msg.action_report:
                ...
                for file_info in output_files:
                    ...
                    if file_type == "deliverable":
                        oss_url = file_info.get("oss_url")
                        preview_url = file_info.get("preview_url")
                        if oss_url and oss_url.startswith("gyra-fs://"):
                            content_url = oss_url
                        else:
