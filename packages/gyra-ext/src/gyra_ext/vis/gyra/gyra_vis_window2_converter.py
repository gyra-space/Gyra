...
from gyra.agent.core.schema import Status, AgentSpaceMode
from gyra.vis.vis_converter import SystemVisTag
from gyra_ext.vis.common.tags.gyra_work_space import WorkSpaceContent, FolderNode
from gyra_ext.vis.gyra.gyra_vis_converter import DrskVisTagPackage
from gyra_ext.vis.gyra.gyra_vis_incr_converter import GyraVisIncrConverter
from gyra_ext.vis.gyra.tags.gyra_running_window import GyraRunningWindow, RunningWindowContent
from gyra_ext.vis.gyra.tags.gyra_space_llm import LLMSpace, LLMSpaceContent

from gyra_ext.vis.gyra.tags.drsk_content import DrskTextContent, DrskContent
from gyra_ext.vis.gyra.tags.drsk_thinking import DrskThinkingContent, DrskThinking
from gyra_ext.vis.gyra.tags.nex_planning_window import NexPlansContent, NexTaskContent, PlanningWindowContent
...
class GyraIncrVisWindow2Converter(GyraVisIncrConverter):
    ...
    def reuse_name(self):
        ## 复用下面转换器的前端布局
        from gyra_ext.vis.gyra.gyra_vis_window_converter import GyraIncrVisWindowConverter
    ...
    async def _planning_vis_build(self, planning_uid, plans_map: Optional[Dict[str, GptsPlan]] = None,
        ...
        from gyra.agent import ResourceType
    ...
    async def _all_running_vis_build(self, messages: List[GptsMessage],
        ...
        from gyra.agent import ConversableAgent
        ## 通过消息构建 agent items
        ...
        return self.vis_inst(GyraRunningWindow.vis_tag()).sync_display(
