...
from gyra_ext.vis.gyra.tags.drsk_msg import DrskTaskPlanContent

NONE_GOAL_PREFIX: str = "none_goal_count_"
logger = logging.getLogger(__name__)


class GyraJsonConverter(VisProtocolConverter):


    def __init__(self, paths: Optional[str] = None, **kwargs):
        self._gyra_url = kwargs.get("gyra_url", "")
        default_tag_paths = ["gyra_ext.vis.gyra.tags"]
        super().__init__(paths if paths else default_tag_paths)

    @property
    def render_name(self):
        return "gyra_json_all"
    ...
    def tag_config(self):
        return {"gyra_url": self._gyra_url}
