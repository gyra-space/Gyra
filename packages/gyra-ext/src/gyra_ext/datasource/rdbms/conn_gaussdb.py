...
class GaussDBConnector(RDBMSConnector):
    ...
    def get_indexes(self, table_name: str) -> List[Dict]:
        ...
        base connector contract (list of dicts with name, column_names,
        unique). Returning raw tuples broke callers expecting dicts, e.g.
        schema learning failed with ``'tuple' object has no attribute 'get'``.
        """
        schema = self._schema or "public"
