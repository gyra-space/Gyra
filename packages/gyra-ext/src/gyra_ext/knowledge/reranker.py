...
gyra has no wired reranker-model runtime (the `RerankEmbeddings` ABC in
gyra.core.interface.embeddings exists but no provider is registered for
...
from gyra.knowledge.types import DocHit
