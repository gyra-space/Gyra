...
from gyra.agent.resource import PackResourceParameters, ResourceParameters
...
def get_open_rca_scenes():
    from gyra_ext.agent.agents.open_rca.resource.open_rca_base import OpenRcaScene
