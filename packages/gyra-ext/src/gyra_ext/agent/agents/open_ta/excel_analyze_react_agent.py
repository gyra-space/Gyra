...
#             "ExcelExpert",
#             category="agent",
#             key="gyra_agent_expand_excel_analysis_expert_name",
#         ),
#         role=DynConfig(
#             "ExcelAnalysisExpert",
#             category="agent",
#             key="gyra_agent_expand_excel_analysis_expert_role",
#         ),
#         goal=DynConfig(
...
#                 from gyra_ext.agent.agents.open_ta.tools.excel_reader import resolve_path
