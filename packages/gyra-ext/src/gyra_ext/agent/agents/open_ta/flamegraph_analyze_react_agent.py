...
# from gyra.agent.expand.react_agent.react_agent import ReActAgent
#
...
#             "FlamegraphExpert",
#             category="agent",
#             key="gyra_agent_expand_flamegraph_analysis_expert_name",
#         ),
#         role=DynConfig(
#             "FlamegraphAnalysisExpert",
#             category="agent",
#             key="gyra_agent_expand_flamegraph_analysis_expert_role",
#         ),
#         goal=DynConfig(
#             "根据绑定的技能(工具, MCP/Local Tool)、子Agent、知识库，"
#             "动态规划执行计划，直至任务完成。关键词: ReAct、PromptEngineering。",
#             category="agent",
#             key="gyra_agent_expand_reasoning_assistant_agent_role",
#         ),
...
#                 _bucket = "gyra_app_file"
#                 from gyra_ext.agent.agents.open_ta.tools.excel_reader import resolve_path_simpale
