...
import logging
import os
from typing import TYPE_CHECKING, Dict, List, NamedTuple, Optional, Any, Union, Tuple
...
from gyra.core.interface.file import _SCHEMA, FileStorageClient
from gyra.util.pd_utils import csv_colunm_foramt
...
def resolve_path_simpale(file_param: Any, conv_uid: str, fs_client: FileStorageClient, bucket: str
) -> Tuple[str, str]:
    ...
    database_root_path = os.path.join(DATA_DIR, "_chat_file_tmp")
...
def resolve_path( file_param: Any, conv_uid: str, fs_client: FileStorageClient, bucket: str
