...
from gyra.agent.expand.actions.tool_action import ToolInput, ToolAction, EVAL_MODE_KEY, TOOL_RUN_MODE_KEY
from gyra.agent.resource import BaseTool, ToolPack
from gyra_ext.vis.common.tags.gyra_monitor import MonitorSpace, MonitorSpaceContent
...
class FileInfo:
    ...
    字段说明：
    - file_full_name: str
        OSS上文件的完整路径。例如："gyra/2816ebhcsd21csacc/db.xlsx"
    - file_type: str
    ...
    示例：
        # Excel 文件
        FileInfo(
            file_full_name="gyra/2816ebhcsd21csacc/db.xlsx",
            file_type="xlsx",
        ...
        # CSV 文件
        FileInfo(
            file_full_name="gyra/2816ebhcsd21csacc/data.csv",
            file_type="csv",
        ...
        # TXT 文件
        FileInfo(
            file_full_name="gyra/2816ebhcsd21csacc/readme.txt",
            file_type="txt",
            structure="text",
        ...
        # PNG 图片
        FileInfo(
            file_full_name="gyra/2816ebhcsd21csacc/image.png",
            file_type="png",
            structure="image",
            sample_data="PNG",
            file_desc="示例PNG图片",
    ...
    def __init__(self, file_full_name: str, file_type, structure: str = "", sample_data: str = "", file_desc: str = "",
        ...
        """
        :param file_full_name: oss上文件完整路径，必填，例如"gyra/2816ebhcsd21csacc/db.xlsx"
...
class MonitorAction(ToolAction):
    ...
    def __init__(self, **kwargs):
        ...
        self.web_url = kwargs.get("gyra_url", "")
