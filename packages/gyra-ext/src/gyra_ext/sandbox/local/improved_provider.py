...
from gyra.sandbox.base import SandboxBase, SandboxOpts
from gyra.sandbox.client.sandbox.types import SandboxDetail
from gyra.sandbox.providers.base import (
    SessionConfig,
    ExecutionResult,
    ExecutionStatus,
)
from gyra_ext.sandbox.local.improved_runtime import (
...
from gyra_ext.sandbox.local.playwright_browser_client import (
...
class ImprovedLocalSandbox(SandboxBase):
    ...
    async def _init_clients(self) -> None:
        ...
        if self._enable_browser:
            ...
            from gyra_ext.sandbox.local.browser_client import LocalBrowserClient
    ...
    async def _sync_from_database_tracked_repos(self) -> int:
        ...
        try:
            ...
            logger.debug("gyra_serve not available, skipping database-tracked sync")
            return 0
        except Exception as e:
