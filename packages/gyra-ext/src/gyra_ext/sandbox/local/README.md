...
This directory contains an enhanced local sandbox implementation with proper security isolation, real browser automation, and complete feature support for the Gyra platform.
...
```python
from gyra_ext.sandbox.local import (
...
```python
from gyra_ext.sandbox.local import create_local_sandbox_from_toml
...
```python
from gyra_ext.sandbox.local import MacOSSandboxProfileConfig
...
This implementation is part of the Gyra project.
