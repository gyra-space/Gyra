...
from gyra_ext.knowledge.vaultfs.base import TRUST_MIN_RECALL
...
class KnowledgeVaultMemoryStore(MemoryStoreBase):
    ...
    async def write_doc(
        ...
        """
        from gyra.storage.memory.threat_scanner import scan_memory_content
    ...
    async def curate_merge(
        ...
        """
        from gyra.storage.memory.threat_scanner import scan_memory_content
        from gyra_ext.knowledge.vaultfs.base import DocDriftError
    ...
    async def _doc_trust(self, path: str) -> float:
        ...
        """
        from gyra_ext.knowledge.vaultfs.base import trust_of
        try:
