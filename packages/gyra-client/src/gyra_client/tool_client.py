...
from gyra_client.schema import BaseAssetModel
...
class ToolClient:
    ...
    def __init__(self,
                 ...
                 gyracore_prod_base_url: str = "",
                 ):
        self.nex_client_id = nex_client_id
        self.nex_token = nex_token
        self.gyracore_prod_base_url = gyracore_prod_base_url
        self.tool_detail_query_url = f"{self.gyracore_prod_base_url}/api/v1/tool_detail/query_all"
