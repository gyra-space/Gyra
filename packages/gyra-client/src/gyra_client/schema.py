"""this module contains the schemas for the gyra client."""
...
from gyra._private.pydantic import BaseModel, ConfigDict, Field, validator
from gyra.core import HumanMessage

# TODO: rewire to new knowledge module (Task #9)
try:
    from gyra_ext.rag.chunk_manager import ChunkParameters  # type: ignore
...
class ChatCompletionRequestBody(BaseModel):
    ...
    vis_mode: Optional[str] = Field(
        default=None, description="gyra message vis mode"
    )
