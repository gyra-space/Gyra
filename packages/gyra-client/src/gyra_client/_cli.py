...
from gyra.core.awel import DAG, BaseOperator, DAGVar
from gyra.core.awel.dag.dag_manager import DAGMetadata, _parse_metadata
from gyra.core.awel.flow.flow_factory import FlowFactory
from gyra.util import get_or_create_event_loop
from gyra.util.console import CliLogger
...
def _check_local_dag(
    ...
    from gyra.core.awel import HttpTrigger
...
def _parse_local_dag(name: str, filepath: str | None = None) -> Tuple[DAG, DAGMetadata]:
    ...
    if not filepath:
        # Load DAG from installed package(gyras)
        ...
        from gyra.core.awel.dag.loader import _process_file
