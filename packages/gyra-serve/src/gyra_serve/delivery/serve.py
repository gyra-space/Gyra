...
class Serve(BaseServe):
    ...
    def on_init(self):
        from .models.models import DeliveryEntity  # noqa: F401
        _ = DeliveryEntity.__tablename__
    ...
    def before_start(self):
        ...
        try:
            ...
            logger.warning(f"Failed to create Delivery tables: {e}")
