...
from gyra.agent.core.schema import DynamicParam, DynamicParamView
from gyra.component import SystemApp, ComponentType
        ...
        for item in AppParamType:
            match item:
                case AppParamType.Resource:
                    ...
                    from gyra.agent.resource.base import FILE_RESOURCES
