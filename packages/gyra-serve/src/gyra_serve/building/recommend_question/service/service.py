...
class Service(BaseService[ServeEntity, ServeRequest, ServerResponse]):
    """The service class for Building/recommendQuestion"""
    ...
    def update(self, request: ServeRequest) -> ServerResponse:
        """Update a Building/recommendQuestion entity
    ...
    def get(self, request: ServeRequest) -> Optional[ServerResponse]:
        """Get a Building/recommendQuestion entity
    ...
    def delete(self, request: ServeRequest) -> None:
        """Delete a Building/recommendQuestion entity
    ...
    def get_list(self, request: ServeRequest) -> List[ServerResponse]:
        """Get a list of Building/recommendQuestion entities
    ...
    def get_list_by_page(
        ...
        """Get a list of Building/recommendQuestion entities by page
    ...
    def delete_by_app_code(self, app_code: str):
        self.dao.delete_by_app_code(app_code)
