...
from gyra.core import Chunk, Document
from gyra.jieba import jieba_util

# TODO: rewire to new knowledge module (Task #9)
try:
    from gyra.rag.embedding.embedding_factory import RerankEmbeddingFactory  # type: ignore
    from gyra.rag.retriever.rerank import RerankEmbeddingsRanker  # type: ignore
...
try:
    from gyra_serve.rag.service.service import Service as KnowledgeService  # type: ignore
except ImportError:  # pragma: no cover - rag module removed
...
class Service(BaseService):
    ...
    def asset_search(self, request: AssetKnowledgeSearchRequest, asset_type) -> List[
        ...
        rerank_embeddings = RerankEmbeddingFactory.get_instance(
            self.system_app
        ).create(model_name="gyra/bge-reranker-v2-m3")
