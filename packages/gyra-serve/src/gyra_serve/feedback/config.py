...
APP_NAME = "feedback"
SERVE_APP_NAME = "gyra_serve_feedback"
SERVE_APP_NAME_HUMP = "gyra_serve_Feedback"
SERVE_CONFIG_KEY_PREFIX = "gyra.serve.feedback."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "gyra_serve_feedback"
