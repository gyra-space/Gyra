...
from gyra_serve.sql_guard.guard import SQLGuard, get_sql_guard

logger = logging.getLogger(__name__)

# Component name for registration
SQL_GUARD_COMPONENT_NAME = "gyra_serve_sql_guard"
...
def init_sql_guard(
    ...
    if app is not None:
        from gyra_serve.sql_guard.api.endpoints import router
