...
from gyra_serve.sql_guard.config import SQLGuardConfig
from gyra_serve.sql_guard.models import (
    ParsedSQL,
    RiskLevel,
    RuleResult,
    SQLCheckContext,
...
from gyra_serve.sql_guard.rules.base import BaseRule
from gyra_serve.sql_guard.rules.permission_rules import (
    ColumnAccessRule,
    DefaultPermissionProvider,
    PermissionProvider,
    TableAccessRule,
)
from gyra_serve.sql_guard.rules.scope_rules import RequireWhereRule, SelectLimitRule
from gyra_serve.sql_guard.rules.syntax_rules import (
    BlockDDLRule,
    ...
    def _log_audit(
        ...
        try:
            if self._audit_dao is None:
                from gyra_serve.sql_guard.audit.dao import SqlAuditLogDao
