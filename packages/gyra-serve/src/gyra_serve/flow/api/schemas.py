...
from gyra.core.awel.util.parameter_util import RefreshOptionRequest
...
class RefreshNodeRequest(BaseModel):
    ...
    model_config = ConfigDict(title="RefreshNodeRequest")
    id: str = Field(
        ...,
    ...
    type_cls: str = Field(
        ...
        examples=["gyra.core.operator.llm.LLMOperator"],
    )
...
class FlowDebugRequest(BaseModel):
    ...
    model_config = ConfigDict(title="FlowDebugRequest")
