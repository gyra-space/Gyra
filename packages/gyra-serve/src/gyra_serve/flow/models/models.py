...
from gyra.core.awel.flow.flow_factory import State
from gyra.core.interface.variables import StorageVariablesProvider
...
class ServeEntity(Model):
    ...
    label = Column(String(128), name="label_info", nullable=True, comment="Flow label")
...
class VariablesEntity(Model):
    ...
    id = Column(Integer, primary_key=True, comment="Auto increment id")
    key = Column(
        String(128), name="key_info", index=True, nullable=False, comment="Variable key"
    )
    name = Column(String(128), index=True, nullable=True, comment="Variable name")
    label = Column(
        String(128), name="label_info", nullable=True, comment="Variable label"
    )
