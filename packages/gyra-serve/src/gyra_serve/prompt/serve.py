...
from gyra.core import PromptManager
...
class Serve(BaseServe):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from gyra.core import PromptTemplate
            from gyra_serve.prompt.serve import Serve, SERVE_APP_NAME
    ...
    def before_start(self):
        ...
        # import your own module here to ensure the module is loaded before the
        # application starts
        from gyra.core.interface.prompt import PromptManager
