...
from gyra_serve.datasource.manages.learning_subtask_db import (
...
class SchemaLearningService:
    ...
    def _detect_sensitive_columns(self, datasource_id: int) -> None:
        ...
        """
        try:
            from gyra_serve.sql_guard.masking.config_db import SensitiveColumnDao
            from gyra_serve.sql_guard.masking.detector import (
