...
from gyra.datasource.base import BaseConnector, BaseDatasourceParameters
from gyra.util.annotations import Deprecated
from gyra.util.executor_utils import ExecutorFactory
from gyra.util.parameter_utils import _get_parameter_descriptions
from gyra_ext.datasource.schema import DBType
from gyra_serve.core import ResourceParameters, ResourceTypes
...
class ConnectorManager(BaseComponent):
    ...
    @classmethod
    def pkg_import(cls):
        from gyra.datasource.rdbms.base import RDBMSConnector  # noqa: F401

        # Graph / NoSQL connectors
        from gyra_ext.datasource.conn_tugraph import TuGraphConnector  # noqa: F401
        from gyra_ext.datasource.conn_neo4j import Neo4jConnector  # noqa: F401
        from gyra_ext.datasource.conn_spark import SparkConnector  # noqa: F401

        # RDBMS connectors
        from gyra_ext.datasource.rdbms.conn_mysql import MySQLConnector  # noqa: F401
        from gyra_ext.datasource.rdbms.conn_oceanbase import (  # noqa: F401
            OceanBaseConnector,
        )
        from gyra_ext.datasource.rdbms.conn_postgresql import (  # noqa: F401
            PostgreSQLConnector,
        )
        from gyra_ext.datasource.rdbms.conn_sqlite import (  # noqa: F401
            SQLiteConnector,
        )
        from gyra_ext.datasource.rdbms.conn_duckdb import (  # noqa: F401
            DuckDbConnector,
        )
        from gyra_ext.datasource.rdbms.conn_excel import (  # noqa: F401
            CsvConnector,
            ExcelConnector,
        )
        from gyra_ext.datasource.rdbms.conn_mssql import (  # noqa: F401
            MSSQLConnector,
        )
        from gyra_ext.datasource.rdbms.conn_oracle import (  # noqa: F401
            OracleConnector,
        )
        from gyra_ext.datasource.rdbms.conn_vertica import (  # noqa: F401
            VerticaConnector,
        )
        from gyra_ext.datasource.rdbms.conn_clickhouse import (  # noqa: F401
            ClickhouseConnector,
        )
        from gyra_ext.datasource.rdbms.conn_starrocks import (  # noqa: F401
            StarRocksConnector,
        )
        from gyra_ext.datasource.rdbms.conn_doris import (  # noqa: F401
            DorisConnector,
        )
        from gyra_ext.datasource.rdbms.conn_hive import (  # noqa: F401
            HiveConnector,
        )
        from gyra_ext.datasource.rdbms.conn_gaussdb import (  # noqa: F401
            GaussDBConnector,
        )
        from gyra_ext.datasource.rdbms.conn_opengauss import (  # noqa: F401
            openGaussConnector,
        )

        # Dialect extensions
        from gyra_ext.datasource.rdbms.dialect.oceanbase.ob_dialect import (  # noqa: F401
            OBDialect,
        )
