...
from gyra.component import SystemApp, LifeCycle
...
class MultimodalService(LifeCycle):
    ...
    def upload_file(
        ...
        from gyra.util.utils import blocking_func_to_async
        import asyncio
    ...
    def match_model_for_content(
        ...
        from gyra.core.interface.media import MediaContentType
