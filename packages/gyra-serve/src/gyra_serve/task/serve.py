...
class Serve(BaseServe):
    ...
    def on_init(self):
        from .models.models import TaskEntity, TaskRelationEntity  # noqa: F401
        _ = [TaskEntity.__tablename__, TaskRelationEntity.__tablename__]
    ...
    def before_start(self):
        ...
        try:
            ...
            logger.warning(f"Failed to create Task tables: {e}")
