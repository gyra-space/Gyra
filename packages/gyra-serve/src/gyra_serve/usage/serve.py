...
class Serve(BaseServe):
    ...
    - Registers a DB-backed recorder to gyra-core's AIWrapper.create on startup
    - Creates the gyra_serve_llm_usage table
    """
    ...
    def before_start(self):
        """Create table and register the DB recorder to gyra-core."""
