...
from gyra_serve.evaluate.api.schemas import EvaluateServeRequest
from gyra_serve.evaluate.config import SERVE_SERVICE_COMPONENT_NAME, ServeConfig
from gyra_serve.evaluate.service.service import Service
...
def get_prompt_service() -> PromptService:
    return global_system_app.get_component("gyra_serve_prompt_service", PromptService)
