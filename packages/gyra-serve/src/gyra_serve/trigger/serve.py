...
class Serve(BaseServe):
    ...
    def on_init(self):
        from .models.models import TriggerSourceEntity  # noqa: F401
        _ = TriggerSourceEntity.__tablename__
    ...
    def before_start(self):
        ...
        try:
            ...
            logger.warning(f"Failed to create Trigger tables: {e}")
