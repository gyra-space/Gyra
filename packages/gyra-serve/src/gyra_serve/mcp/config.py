...
APP_NAME = "mcp"
SERVE_APP_NAME = "gyra_serve_mcp"
SERVE_APP_NAME_HUMP = "gyra_serve_Mcp"
SERVE_CONFIG_KEY_PREFIX = "gyra_serve.mcp."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "gyra_serve_mcp"
...
DEFAULT_MCP_REPO_URL = "https://github.com/gyra-ai/gyra-mcps"
