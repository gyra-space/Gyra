...
from gyra.channel import ChannelConfig, ChannelType
from gyra.channel.schemas import DingTalkConfig, FeishuConfig
...
class Service(BaseService[ChannelEntity, ChannelRequest, ChannelResponse]):
    ...
    def init_app(self, system_app: SystemApp) -> None:
        ...
        # 设置默认消息处理器，带Agent集成
        from gyra.channel.router import AgentMessageHandler
