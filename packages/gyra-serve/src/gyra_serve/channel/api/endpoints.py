...
# Webhook endpoints (placeholder - actual implementation in gyra-ext)
@router.post(
...
async def dingtalk_webhook(
    ...
    by the DingTalk channel handler in gyra-ext.
    ...
    return {
        ...
        "message": "Webhook received (placeholder - implement in gyra-ext)",
    }
...
async def feishu_webhook(
    ...
    This is a placeholder. The actual implementation should be provided
    by the Feishu channel handler in gyra-ext.
