...
APP_NAME = "channel"
SERVE_APP_NAME = "gyra_serve_channel"
SERVE_APP_NAME_HUMP = "gyra_serve_Channel"
SERVE_CONFIG_KEY_PREFIX = "gyra.serve.channel."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "gyra_serve_channel_config"
