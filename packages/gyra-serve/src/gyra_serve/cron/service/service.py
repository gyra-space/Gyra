...
class Service(BaseService[CronJobEntity, ServeRequest, ServerResponse], CronScheduler):
    ...
    async def _execute_agent_turn(self, job: CronJob) -> bool:
        ...
        """
        from gyra.cron import SessionMode
        import uuid
    ...
    async def _execute_trigger_fire(self, job: CronJob) -> bool:
        ...
        try:
            ...
            from gyra_serve.trigger.api.schemas import TriggerFireRequest
    ...
    def _entity_to_cron_job(self, entity: CronJobEntity) -> CronJob:
        ...
        Returns:
            A CronJob instance.
        """
        from gyra.cron import CronPayload, CronSchedule, CronJobState, SessionMode
