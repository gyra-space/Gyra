...
class GyraFileSystem(AbstractFileSystem):
    """Interface to files in GyraFileSystem
    ...
    def created(self, path):
        ...
        raise NotImplementedError("created() is not supported by DersikFileSystem")

    def modified(self, path):
        """Get modification time - not supported."""
        raise NotImplementedError("modified() is not supported by DersikFileSystem")

    def mkdir(self, path, create_parents=True, **kwargs):
        """Create directory - not needed for DersikFileSystem."""
        # No-op since we don't have directories
        pass

    def makedirs(self, path, exist_ok=True):
        """Create directory and parents - not needed for DersikFileSystem."""
        # No-op since we don't have directories
        pass
...
class GyraFile(io.IOBase):
    """File-like interface for GyraFileSystem."""
