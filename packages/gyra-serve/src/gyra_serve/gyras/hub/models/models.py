...
class ServeEntity(Model):
    ...
    name = Column(String(255), unique=True, nullable=False, comment="gyras name")
    description = Column(String(255), nullable=False, comment="gyras description")
    author = Column(String(255), nullable=True, comment="gyras author")
    email = Column(String(255), nullable=True, comment="gyras author email")
    type = Column(String(255), comment="gyras type")
    version = Column(String(255), comment="gyras version")
    storage_channel = Column(String(255), comment="gyras storage channel")
    storage_url = Column(String(255), comment="gyras download url")
    download_param = Column(String(255), comment="gyras download param")
    gmt_created = Column(
        DateTime,
        name="gmt_create",
    ...
    UniqueConstraint("name", "type", name="uk_gyras")
