"""Intervention serve module entry."""
import logging
...
class Serve(BaseServe):
    ...
    def on_init(self):
        from .models.models import InterventionEntity  # noqa: F401
        _ = InterventionEntity.__tablename__
    ...
    def before_start(self):
        ...
        try:
            ...
            logger.warning(f"Failed to create Intervention tables: {e}")
