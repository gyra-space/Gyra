...
from gyra.agent.resource.database import (
...
class DatasourceResource(RDBMSConnectorResource):
    ...
    def spec_service(self):
        ...
        if self._spec_service is None:
            try:
                from gyra_serve.datasource.service.spec_service import (
                    DbSpecService,
                )
    ...
    def schema_link_service(self):
        ...
        if self._schema_link_service is None:
            try:
                from gyra_serve.datasource.service.schema_link_service import (
                    SchemaLinkService,
                )
