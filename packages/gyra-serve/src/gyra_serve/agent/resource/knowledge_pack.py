...
from gyra.agent.resource.knowledge import (
    RetrieverResource,
...
try:
    from gyra.rag.transformer.tag_extractor import MetadataTag  # type: ignore
except ImportError:  # pragma: no cover - rag module removed
    MetadataTag = None  # type: ignore[assignment]

from gyra.storage.vector_store.filters import MetadataFilters, MetadataFilter, \
    FilterCondition
