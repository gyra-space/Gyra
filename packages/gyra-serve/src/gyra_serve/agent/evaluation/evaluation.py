...
from gyra.core import Embeddings, LLMClient
from gyra.core.awel import IteratorTrigger, JoinOperator, MapOperator
from gyra.core.awel.task.base import IN, OUT
...
try:
    from gyra.rag.evaluation import RetrieverSimilarityMetric  # type: ignore
...
class AgentEvaluator(Evaluator):
    ...
    Examples:
        .. code-block:: python
            ...
            import os
            import asyncio
            from gyra.rag.operators import (
                EmbeddingRetrieverOperator,
                RetrieverEvaluatorOperator,
            )
            from gyra.rag.evaluation import (
                RetrieverEvaluator,
                RetrieverSimilarityMetric,
            )
            from gyra.rag.embedding import DefaultEmbeddingFactory
            from gyra.storage.vector_store.chroma_store import ChromaVectorConfig
            from gyra.storage.vector_store.connector import VectorStoreConnector
            from gyra.configs.model_config import MODEL_PATH, PILOT_PATH
    ...
    async def evaluate(
        ...
        **kwargs,
        ...
        from gyra.core.awel import DAG, MapOperator
