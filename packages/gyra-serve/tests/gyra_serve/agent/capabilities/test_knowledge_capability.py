...
from gyra_serve.agent.capabilities.knowledge import KnowledgeCapabilityResource
...
def test_facade_wraps_legacy_knowledge():
    ...
    from gyra_serve.agent.capabilities.knowledge import register_wrappers
...
async def test_knowledge_capability_register_and_facade_flip():
    ...
    from gyra_serve.agent.capabilities.knowledge import register_capability
    facade = ResourceFacade()
