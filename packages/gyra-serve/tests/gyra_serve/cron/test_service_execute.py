...
from gyra.agent.tools.registry import register_builtin_tools, tool_registry
from gyra.agent.tools.result import ToolResult
from gyra.cron import CronJob, CronPayload, CronSchedule, PayloadKind, ScheduleKind
...
class _StubService:
    ...
    from gyra_serve.cron.service.service import (
        Service as _Svc,
    )
