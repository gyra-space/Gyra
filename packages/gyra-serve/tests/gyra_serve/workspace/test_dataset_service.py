...
from gyra_ext.datasource.rdbms.conn_duckdb import DuckDbConnector
from gyra_ext.datasource.rdbms.conn_excel import (  # noqa: F401 注册子类
    CsvConnector,
    ExcelConnector,
)
...
from gyra_serve.datasource.manages.db_spec_db import DbSpecDao  # noqa: F401 建表
from gyra_serve.datasource.manages.table_spec_db import TableSpecDao
from gyra_serve.datasource.service.learning_service import SchemaLearningService
