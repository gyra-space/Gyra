...
def test_workspace_scene_factory_registered():
    """discover() 扫到 gyra_serve.agent.capabilities.workspace_scene,
...
def test_workspace_scene_factory_builds_capability_from_value_dict():
    ...
    from gyra_serve.workspace.scene_capability import (
    ...
    with patch(
        "gyra_serve.workspace.scene_resource.build_scene_management_tools"
    ) as mtools:
