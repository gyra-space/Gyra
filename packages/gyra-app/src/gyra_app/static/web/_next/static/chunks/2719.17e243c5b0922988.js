...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[2719], { 1600: (t, e, r) => {
  "use strict";
  r.d(e, { A: () => s });
...
${a2.join("\n")}`);
  ...
  var A = { id: "c4", detector: (0, h.K)((t10) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(t10), "detector"), loader: (0, h.K)(async () => {
  ...
  }, "loader"), t5 = { id: t1, detector: t2, loader: t3 }, t6 = "radar", t8 = (0, h.K)((t10) => /^\s*radar-beta/.test(t10), "detector"), t9 = (0, h.K)(async () => {
    let { diagram: t10 } = await Promise.all([r.e(3265), r.e(2201), r.e(6997)]).then(r.bind(r, 76997));
    return { id: t6, diagram: t10 };
  }, "loader"), t4 = { id: t6, detector: t8, loader: t9 }, t7 = "block", et = (0, h.K)((t10) => /^\s*block(-beta)?/.test(t10), "detector"), ee = (0, h.K)(async () => {
    ...
    }, "parse") }, init: (0, h.K)(() => null, "init") }, (t10) => t10.toLowerCase().trimStart().startsWith("---")), (0, c.Xd)(tI, tH, eu), (0, c.Xd)(A, tZ, tw, tm, D, q, G, Z, tl, td, P, R, C, tU, B, tC, tA, tR, tt, t0, t5, ta, er, ef, es, t4, eb, eS, eI, eU, eH, eZ, ev, eT, eE));
  ...
  }, (0, h.K)(_a, "Diagram"), _a), e3 = [], e5 = (0, h.K)(() => {
    e3.forEach((t10) => {
      t10();
    }), e3 = [];
  }, "attachFunctions"), e6 = (0, h.K)((t10) => t10.replace(/^\s*%%(?!{)[^\n]+\n?/gm, "").trimStart(), "cleanupComments");
  function e8(t10) {
  ...
  (0, h.K)(e8, "extractFrontMatter");
  var e9 = (0, h.K)((t10) => t10.replace(/\r\n?/g, "\n").replace(/<(\w+)([^>]*)>/g, (t11, e10, r2) => "<" + e10 + r2.replace(/="([^"]*)"/g, "='$1'") + ">"), "cleanupText"), e4 = (0, h.K)((t10) => {
    let { text: e10, metadata: r2 } = e8(t10), { displayMode: n2, title: a2, config: i2 = {} } = r2;
  ...
  function rt(t10) {
    let e10 = e4(e9(t10)), r2 = e7(e10.text), n2 = (0, l.$t)(e10.config, r2.directive);
    return { code: t10 = e6(r2.text), title: e10.title, config: n2 };
  }
  function re(t10) {
...
`;
  ...
  var rf = (0, h.K)((t10, e10, r2, n2) => {
    ...
    let L2 = (0, h.K)(() => {
      ...
      return u.R.debug("config.arrowMarkerAbsolute", s2.arrowMarkerAbsolute), e11 = ru(e11, k2, (0, c._3)(s2.arrowMarkerAbsolute)), k2 ? e11 = rh(e11, y2.select(g2 + " svg").node()) : w2 || (e11 = b.default.sanitize(e11, { ADD_TAGS: rr, ADD_ATTR: rn, HTML_INTEGRATION_POINTS: { foreignobject: true } })), e5(), e11;
    }, "serializeSvg")();
    if (a2) throw a2;
  ...
  "use strict";
  r.d(e, { A: () => o });
  var n = r(63927), a = r(81693), i = r(78081), s = r(41310);
  ...
  r.d(e, { JLW: () => nt.A, l78: () => f, tlR: () => p, qrM: () => nh, Yu4: () => np, IA3: () => ng, Wi0: () => ny, PGM: () => nb, OEq: () => nw, y8u: () => nv.Ay, olC: () => nx.A, IrU: () => nA, oDi: () => nS.A, Q7f: () => nM.A, cVp: () => nC, lUB: () => nT.A, Lx9: () => nL.A, nVG: () => nO.G, uxU: () => nO.N, Xf2: () => nE, GZz: () => nj.Ay, UPb: () => nj.Ps, dyv: () => nj.Ko, GPZ: () => tj.GP, Sk5: () => tP.Ay, bEH: () => t1, n8j: () => ne.A, T9B: () => s.A, jkA: () => o.A, rLf: () => no, WH: () => function t10() {
    var e10, r10, n2 = t8().unknown(void 0), a2 = n2.domain, i2 = n2.range, s2 = 0, o2 = 1, l2 = false, c2 = 0, u2 = 0, h2 = 0.5;
    function d2() {
    ...
    return r10.copy = function() {
      ...
      var r11 = e10();
      return (0, t9.Ay)(r11[0], r11[r11.length - 1], null == t11 ? 10 : t11);
    }, r10.tickFormat = function(t11, r11) {
      var n2 = e10();
      return (function(t12, e11, r12, n3) {
        var a2, i2, s2, o2 = (0, t9.sG)(t12, e11, r12);
      ...
      for (c2 < l2 && (a2 = l2, l2 = c2, c2 = a2, a2 = s2, s2 = o2, o2 = a2); u2-- > 0; ) {
        if ((a2 = (0, t9.lq)(l2, c2, t11)) === n2) return i2[s2] = l2, i2[o2] = c2, e10(i2);
  ...
  }, UMr: () => t8, w7C: () => r9, zt: () => r4.zt, Ltv: () => r7, UAC: () => ex, DCK: () => i, TUC: () => eT, Agd: () => ek, t6C: () => eg, wXd: () => ey, ABi: () => eS, Ui6: () => eF, rGn: () => eO, ucG: () => em, YPH: () => eM, Mol: () => eL, PGu: () => eK, GuW: () => eC, hkb: () => tD.A });
  ...
  var t5 = r(71927);
  let t6 = /* @__PURE__ */ Symbol("implicit");
  function t8() {
    var t10 = new t5.B(), e10 = [], r10 = [], n2 = t6;
    function a2(a3) {
      let i2 = t10.get(a3);
      if (void 0 === i2) {
        if (n2 !== t6) return n2;
    ...
    return a2.domain = function(r11) {
      ...
      for (let n3 of (e10 = [], t10 = new t5.B(), r11)) t10.has(n3) || t10.set(n3, e10.push(n3) - 1);
      return a2;
      ...
      return t8(e10, r10).unknown(n2);
    }, t3.apply(a2, arguments), a2;
  }
  var t9 = r(37208), t4 = r(11224), t7 = r(2960);
  function et(t10, e10) {
    return t10 *= 1, e10 *= 1, function(r10) {
  ...
  function eY(t10, e10, r10, n2, a2, i2) {
    ...
    function o2(e11, r11, n3) {
      ...
      if (i3 === s2.length) return t10.every((0, t9.sG)(e11 / 31536e6, r11 / 31536e6, n3));
      if (0 === i3) return eg.every(Math.max((0, t9.sG)(e11, r11, n3), 1));
  ...
  function r9() {
    return t3.apply((function t10(e10, r10, n2, a2, i2, s2, o2, l2, c2, u2) {
      ...
      return h2.invert = function(t11) {
        ...
        return arguments.length ? p2(Array.from(t11, r8)) : p2().map(r6);
  ...
  i = (a = (function(t10) {
    var e10 = t10.dateTime, r10 = t10.date, n2 = t10.time, a2 = t10.periods, i2 = t10.days, s2 = t10.shortDays, o2 = t10.months, l2 = t10.shortMonths, c2 = e5(a2), u2 = e6(a2), h2 = e5(i2), d2 = e6(i2), p2 = e5(s2), f2 = e6(s2), g2 = e5(o2), m2 = e6(o2), y2 = e5(l2), b2 = e6(l2), k2 = { a: function(t11) {
    ...
    }, Q: r3, s: r5, S: rA, u: rM, U: rS, V: rC, w: rL, W: rT, x: null, X: null, y: rO, Y: r$, Z: rj, "%": r2 }, w2 = { a: function(t11) {
    ...
    }, Q: r3, s: r5, S: rY, u: rq, U: rH, V: rX, w: rG, W: rZ, x: null, X: null, y: rV, Y: rJ, Z: r1, "%": r2 }, x2 = { a: function(t11, e11, r11) {
    ...
    }, q: ra, Q: rf, s: rg, S: ru, u: e9, U: e4, V: e7, w: e8, W: rt, x: function(t11, e11, n3) {
