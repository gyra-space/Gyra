...
class ChatHistory:
    ...
    def _check_store_type(self, store_type: str):
        ...
        if store_type == "duckdb":
            link1 = (
                "https://docs.gyra.site/docs/latest/faq/install#q6-how-to-migrate-meta"
                "-table-chat_history-and-connect_config-from-duckdb-to-sqlite"
            )
            link2 = (
                "https://docs.gyra.site/docs/latest/faq/install/#q7-how-to-migrate-"
            ...
            logger.error(
                ...
                f"type now, you can migrate your message according to {link1} or "
                f"{link2}"
            )
            raise ValueError(f"Invalid store type: {store_type}")
