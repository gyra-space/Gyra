...
```python
# gyra_serve/streaming_config/api.py
...
from gyra.model.streaming.db_models import (
...
async def get_available_tools(
    ...
    """获取可用工具列表"""
    # 返回工具注册表中的工具
    from gyra.agent.tools import ToolRegistry
...
```python
from gyra.model.streaming import (
...
```python
# gyra/model/streaming/chunk_strategies.py
