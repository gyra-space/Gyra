...
from gyra._private.llm_metadata import LLMMetadata
from gyra._private.pydantic import BaseModel, Field, PrivateAttr
from gyra.core.interface.prompt import get_template_vars

# TODO: rewire to new knowledge module (Task #9)
try:
    from gyra.rag.text_splitter.token_splitter import TokenTextSplitter  # type: ignore
except ImportError:  # pragma: no cover - rag module removed
    TokenTextSplitter = None  # type: ignore[assignment]

from gyra.util.global_helper import globals_helper
