...
from gyra.component import ComponentType, T
from gyra.context.base import ContextWindow
from gyra.context.event import EventType
from gyra.context.operator import Operator
...
class Manager(BaseComponent):
    ...
    def after_init(self):
        for _, operator_cls in model_scan("gyra_ext.context.operator", Operator).items():
