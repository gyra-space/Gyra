...
from gyra.core.interface.media import MediaContent, MediaContentType, MediaObject
from gyra.core.interface.message import ModelMessage, ModelMessageRoleType
from gyra.util import BaseParameters
from gyra.util.annotations import PublicAPI
from gyra.util.model_utils import GPUInfo, TokenDetails
...
class MessageConverter(ABC):
    ...
    Examples:
        ...
        >>> from gyra.core.interface.message import ModelMessage, ModelMessageRoleType
        >>> from gyra.core.interface.llm import MessageConverter, ModelMetadata
...
class DefaultMessageConverter(MessageConverter):
    ...
    def move_last_user_message_to_end(
        ...
        Examples:
            ...
            ...     ModelMessageRoleType,
            ... )
            >>> from gyra.core.interface.llm import DefaultMessageConverter
            >>> messages = [
            ...     ModelMessage(
            ...         role=ModelMessageRoleType.SYSTEM,
            ...         content="You are a helpful assistant",
