...
from gyra.core.interface.media import MediaContent, MediaObject
...
def test_to_common_messages_replace_url_func_threads_to_image():
    ...
    image_url = "/api/v2/serve/file/files/gyra_app_file/abc-123?conv_uid=xxx"
    msg = ModelMessage(
...
def test_to_common_messages_replace_url_func_default_none_preserves_url():
    ...
    image_url = "/api/v2/serve/file/files/gyra_app_file/abc-123"
    msg = ModelMessage(
        role=ModelMessageRoleType.HUMAN,
        content=[
