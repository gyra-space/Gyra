...
from gyra.core.awel import BaseOperator, MapOperator
...
class PreChatHistoryLoadOperator(
    ...
    In GYRA, conversation record and the messages in the conversation are stored in
    the storage,
...
class BufferedConversationMapperOperator(ConversationMapperOperator):
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from gyra.core.interface.message import AIMessage, HumanMessage
            from gyra.core.operators import BufferedConversationMapperOperator
    ...
    def _filter_round_messages(
        ...
        Examples:
            >>> from gyra.core import AIMessage, HumanMessage
            >>> from gyra.core.operators import BufferedConversationMapperOperator
            >>> messages = [
            ...     [
            ...         HumanMessage(content="Hi", round_index=1),
