...
from gyra._private.pydantic import model_validator
from gyra.core import ModelMessage, ModelOutput, StorageConversation
from gyra.core.awel import JoinOperator, MapOperator
...
from gyra.core.interface.message import BaseMessage
from gyra.core.interface.operators.llm_operator import BaseLLM
from gyra.core.interface.operators.message_operator import BaseConversationOperator
from gyra.core.interface.prompt import (
...
from gyra.util.function_utils import rearrange_args_by_type
...
class PromptBuilderOperator(
    ...
    Examples:
        .. code-block:: python
            ...
            from gyra.core.operators import PromptBuilderOperator
