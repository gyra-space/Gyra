...
from gyra.core.awel.util.parameter_util import (
    BaseDynamicOptions,
    OptionValue,
    RefreshOptionRequest,
)
from gyra.core.interface.serialization import Serializable
from gyra.util.executor_utils import DefaultExecutorFactory, blocking_func_to_async
from gyra.util.i18n_utils import LazyTranslatedString
...
class BaseMetadata(BaseResource):
    ...
    documentation_url: Optional[str] = Field(
        ...
        examples=["https://docs.gyra.site/docs/awel"],
    )
    ...
    id: str = Field(
        ...
        examples=[
            ...
            "resource_gyra.agent.util.llm.llm_client.AIWrapper",
        ],
    )
...
class ResourceMetadata(BaseMetadata, TypeMetadata):
    ...
    parent_cls: List[str] = Field(
        ...
        examples=[
            "gyra.core.interface.llm.LLMClient",
            "resource_gyra.agent.util.llm.llm_client.AIWrapper",
        ],
    )
...
def auto_register_resource(
    ...
    **decorator_kwargs,
    ...
    from gyra.util.function_utils import TYPE_STRING_TO_TYPE
...
class ViewMetadata(BaseMetadata):
    ...
    type_cls: Optional[str] = Field(
        ...
        examples=["gyra.model.operators.LLMOperator"],
    )
