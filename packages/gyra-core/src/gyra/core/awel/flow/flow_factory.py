...
from gyra.core.awel.dag.base import DAG, DAGNode
from gyra.core.awel.dag.dag_manager import DAGMetadata
...
class FlowNodeData(BaseModel):
    ...
    id: str = Field(
        ...
        examples=[
            ...
            "resource_gyra.agent.util.llm.llm_client.AIWrapper_0",
        ],
    )
...
class FlowEdgeData(BaseModel):
    ...
    source: str = Field(
        ...
        examples=["resource_gyra.agent.util.llm.llm_client.AIWrapper_0"],
    )
...
class _VariablesRequestBase(BaseModel):
    key: str = Field(
        ...
        examples=["gyra.model.openai.api_key"],
    )
...
class VariablesRequest(_VariablesRequestBase):
    ...
    For creating a new variable in the GYRA.
    """
...
class FlowFactory:
    ...
    def pre_load_requirements(self, flow_panel: FlowPanel):
        ...
        """
        from gyra.util.module_utils import import_from_string
