...
_OLD_AGENT_OPERATOR_MODULE = "gyra.serve.agent.team.layout.agent_operator"
_NEW_AGENT_OPERATOR_MODULE = "gyra.agent.core.reasoning_engine.awel.agent_operator"

_OLD_AGENT_RESOURCE_MODULE_1 = "gyra.serve.agent.team.layout.agent_operator_resource"
_OLD_AGENT_RESOURCE_MODULE_2 = (
    "gyra.agent.reasoning_engine.awel.agent_operator_resource"
)
_NEW_AGENT_RESOURCE_MODULE = (
    "gyra.agent.core.reasoning_engine.awel.agent_operator_resource"
)
...
_register(
    "gyra.storage.vector_store.connector",
    "gyra.serve.rag.connector",
