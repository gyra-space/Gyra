...
from gyra.core.awel.flow import IOField, OperatorCategory, Parameter, ViewMetadata
from gyra.core.awel.trigger.http_trigger import CommonLLMHttpRequestBody
from gyra.core.interface.llm import ModelRequest
from gyra.core.interface.message import MessageStorageItem, StorageConversation
from gyra.core.interface.operators.llm_operator import (
    MergedRequestBuilderOperator,
    RequestBuilderOperator,
)
from gyra.core.interface.operators.message_operator import (
    BufferedConversationMapperOperator,
    PreChatHistoryLoadOperator,
)
from gyra.core.interface.operators.prompt_operator import HistoryPromptBuilderOperator
from gyra.core.interface.prompt import ChatPromptTemplate
from gyra.core.interface.storage import StorageInterface
...
class ConversationComposerOperator(MapOperator[CommonLLMHttpRequestBody, ModelRequest]):
    ...
    def _build_composer_dag(self):
        with DAG("gyra_awel_chat_history_prompt_composer") as composer_dag:
