...
from gyra.util.singleton import Singleton

if TYPE_CHECKING:
    from gyra.component import SystemApp
    from gyra.datasource.manages import ConnectorManager
...
class Config(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        self.GYRA_WEBSERVER_PORT = int(os.getenv("GYRA_WEBSERVER_PORT", 8080))
        ...
        from gyra.core._private.prompt_registry import PromptTemplateRegistry
        ...
        # All write operations are blocked by default for safety:
        # - DDL write (CREATE/DROP/ALTER/TRUNCATE): blocked
        # - DML write (INSERT/UPDATE/DELETE): blocked
        # Read operations (SELECT/SHOW/DESCRIBE) are always allowed
        ...
        # Log level
        self.GYRA_LOG_LEVEL = os.getenv("GYRA_LOG_LEVEL", "INFO")
        ...
        self.GYRA_APP_SCENE_NON_STREAMING_RETRIES_BASE = int(
            os.getenv("GYRA_APP_SCENE_NON_STREAMING_RETRIES_BASE", 1)
        )
        # Non-streaming scene parallelism
        self.GYRA_APP_SCENE_NON_STREAMING_PARALLELISM_BASE = int(
            os.getenv("GYRA_APP_SCENE_NON_STREAMING_PARALLELISM_BASE", 1)
        )
