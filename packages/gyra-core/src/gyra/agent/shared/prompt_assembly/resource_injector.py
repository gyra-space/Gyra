...
if TYPE_CHECKING:
    from gyra.agent.resource import (
        AppResource,
        RetrieverResource,
        AgentSkillResource,
    )
...
class ResourceType(str, Enum):
    ...
    对应 gyra.agent.resource.base.ResourceType:
...
class ResourceContext:
    ...
    def _extract_sandbox(self) -> List[ResourceInfo]:
        ...
        agent_skill_dir = "/home/ubuntu/.gyra/skills"
    ...
    def _extract_skill_info(self, item: Any) -> Optional[ResourceInfo]:
        ...
        try:
            ...
            # Use meta.path directly if available (GyraSkillResource computes the correct path)
...
class ResourceInjector:
    ...
    def _get_system_info(self, work_dir: str) -> str:
        ...
        if "/pilot/data/" in work_dir_lower or "gyra" in work_dir_lower:
    ...
    async def _get_database_table_list(self, resource_info: ResourceInfo) -> str:
        ...
        try:
            from gyra_serve.datasource.service.injection_config import (
                get_injection_mode,
