...
from gyra.util.json_utils import parse_or_raise_error
...
from .base import GYRA_TOOL_IDENTIFIER, BaseTool, FunctionTool, ToolFunc
...
from gyra.agent.tools.base import ToolBase as NewToolBase
...
def _is_function_tool(resources: Any) -> bool:
    return (
        callable(resources)
        and hasattr(resources, GYRA_TOOL_IDENTIFIER)
        and getattr(resources, GYRA_TOOL_IDENTIFIER)
