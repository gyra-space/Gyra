...
from gyra.datasource.rdbms.base import RDBMSConnector
from gyra.util.cache_utils import cached
...
class RDBMSConnectorResource(DBResource[DBParameters]):
    ...
    def get_schema_link(
        ...
        from gyra_ext.rag.summary.rdbms_db_summary import _parse_db_summary
...
class SQLiteDBResource(RDBMSConnectorResource):
    ...
    def __init__(
        ...
        from gyra.datasource.rdbms.conn_sqlite import SQLiteConnector
