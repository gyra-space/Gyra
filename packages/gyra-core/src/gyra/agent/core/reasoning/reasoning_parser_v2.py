...
from gyra.agent import Resource, AgentResource
...
from gyra.agent.expand.actions.tool_action import ToolInput
from gyra.agent.resource import FunctionTool, BaseTool, ToolPack, ResourcePack
...
from gyra.core.workflow.workflow_action import WorkflowAction, WorkflowActionInput
from gyra.util.string_utils import is_number
from gyra_ext.agent.actions.ant_tool_action import AntToolAction
...
class FunctionCallParser(ABC):
    ...
    def unpack_ability_resource(self, resource: Resource) -> list[Resource]:
        from gyra_ext.agent.agents.reasoning.utils import ABILITY_RESOURCE_TYPES
        if not resource:
            return []
