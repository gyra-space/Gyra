...
新的代码应该使用:
    ...
    from gyra.agent.tools.decorators import sandbox_tool

旧的代码可以继续使用:
    from gyra.agent.core.sandbox.sandbox_tool_registry import sandbox_tool, sandbox_tool_dict
"""
...
# 向后兼容：导入统一框架
from gyra.agent.tools.decorators import sandbox_tool as _unified_sandbox_tool
from gyra.agent.tools.registry import tool_registry

logger = logging.getLogger(__name__)

GYRA_TOOL_IDENTIFIER = 'sandbox_tool'
...
def register_sandbox_tools_to_unified():
    ...
    from gyra.agent.tools.builtin.sandbox import register_sandbox_tools
