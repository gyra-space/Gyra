...
#
# from gyra.rag.retriever.rerank import RetrieverNameRanker
...
#             "reporter",
#             category="agent",
#             key="gyra_agent_reporter_agent_profile_name",
#         ),
#         role=DynConfig(
#             "Report Expert",
#             category="agent",
#             key="gyra_agent_reporter_agent_profile_role",
#         ),
#         goal=DynConfig(
#             "Summarize answer summaries based on user questions from provided "
#             "resource information or from historical conversation memories.",
#             category="agent",
#             key="gyra_agent_reporter_agent_profile_goal",
#         ),
...
#             ],
#             category="agent",
#             key="gyra_agent_expand_summary_assistant_agent_profile_constraints",
#         ),
#         desc=DynConfig(
