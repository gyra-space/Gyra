...
def create_dattach_content(
    ...
    Example:
        ```python
        from gyra.agent.core.file_system.dattach_utils import create_dattach_content
...
def render_dattach_list(
    ...
    Example:
        ```python
        from gyra.agent.core.file_system.dattach_utils import render_dattach_list
...
def attach(
    ...
    **kwargs,
    ...
    Example:
        ```python
        from gyra.agent.core.file_system.dattach_utils import attach
...
def attach_list(
    ...
    **kwargs,
    ...
    Example:
        ```python
        from gyra.agent.core.file_system.dattach_utils import attach_list
