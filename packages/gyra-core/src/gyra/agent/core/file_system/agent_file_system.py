...
from gyra.agent.core.memory.gpts.file_base import SimpleFileMetadataStorage
...
class AgentFileSystem:
    ...
    async def save_file(
        ...
        file_metadata = AgentFileMetadata(
            ...
            oss_url=storage_uri
            if storage_uri.startswith(("oss://", "gyra-fs://"))
            else None,
    ...
    def _get_app_name(self) -> str:
        ...
        return os.getenv("app_name", "opengyra")
    ...
    def _generate_object_key(
        ...
        示例: dev/opengyra/conversations/conv-123/goal-1/report.md
    ...
    def _extract_object_path_from_url(self, url: Optional[str]) -> Optional[str]:
        ...
        例如: https://antsys-antdbgpt-dev.oss.../agent_files/dev/opengyra/...?...
        返回: agent_files/dev/opengyra/...
