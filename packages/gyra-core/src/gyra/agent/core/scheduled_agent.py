...
from gyra.agent import ConversableAgent, AgentMessage, Agent, ActionOutput
...
from gyra.context.event import ChatPayload, StepPayload, ActionPayload, EventType
from gyra.context.window import ContextWindow
from gyra.core.interface.scheduler import SchedulePayload, Stage, Signal
from gyra.util.date_utils import current_ms
from gyra.util.tracer import trace, root_tracer
...
class ScheduledAgent(ConversableAgent):
    ...
    async def handle_answer(self, payload: SchedulePayload):
        ...
        from gyra.agent import UserProxyAgent
