...
**集成点:** `packages/gyra-core/src/gyra/agent/core/base_agent.py`

#### 1.1 初始化 SessionHistoryManager

```python
# 在 ConversableAgent 类中添加:
from gyra.agent.core.memory.session_history import (
...
**集成点:** `packages/gyra-core/src/gyra/agent/expand/react_master_agent/prompt_fc.py`
