...
from gyra.agent.core.hook.schema import (
    HookConfig,
    HookEndpointConfig,
    HookKind,
    HookTriggerConfig,
...
from gyra.agent.core.hook.trigger_checker import HookTriggerChecker
...
from gyra.agent.core.memory.agent_dispatcher import agent_dispatcher
...
class TestDefaultMemoryHooks:
    ...
    def test_tier01_functions_registered(self):
        from gyra.agent.core.hook.executors import FunctionRegistry
...
class TestMemoryFunctions:
    def setup_method(self):
        from gyra.agent.core.memory import hook_dispatcher as hd
...
class TestAgentDispatcher:
    ...
    def test_real_agent_dispatch_calls_generate_reply(self):
        ...
        with patch(
            "gyra.agent.core.agent_manage.get_agent_manager"
        ) as mock_get_mgr:
            mock_mgr = MagicMock()
