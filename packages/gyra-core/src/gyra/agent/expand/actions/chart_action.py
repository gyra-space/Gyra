...
from gyra._private.pydantic import BaseModel, Field, model_to_json
from gyra.vis import SystemVisTag
from gyra_ext.vis.gptvis.tags.vis_chart import Vis, VisChart
...
class ChartAction(Action[SqlInput]):
    ...
    def __init__(self, **kwargs):
        ...
        self.action_view_tag: str = SystemVisTag.VisChart.value
