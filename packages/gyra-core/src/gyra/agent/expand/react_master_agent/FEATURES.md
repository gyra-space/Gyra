...
**快速使用：**
```python
from gyra.agent.expand.react_master_agent import WorkLogManager
...
**快速使用：**
```python
from gyra.agent.expand.react_master_agent import PhaseManager, TaskPhase
...
```python
# 简单报告
from gyra.agent.expand.react_master_agent import generate_simple_report

report = await generate_simple_report(work_log, "agent_id", "task_id")

# 灵活报告
from gyra.agent.expand.react_master_agent.report_generator import ReportGenerator
