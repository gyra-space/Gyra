...
from gyra.agent.core.action.blank_action import BlankAction
from gyra.agent.core.base_agent import ConversableAgent
from gyra.agent.core.profile import ProfileConfig
    ...
    * returning an `AgentMessage` with the task result
    ...
    def _get_bundle(self, conv_id: str) -> Optional[Any]:
        ...
        if not conv_id:
            return None
        try:
            from gyra.agent.core.memory.hook_dispatcher import get_memory_bundle
