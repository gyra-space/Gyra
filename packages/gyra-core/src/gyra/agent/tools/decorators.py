    ...
    *decorator_args: Union[str, Callable],
    ...
    def _create_decorator(name: str):
        def decorator(func: Callable):
            ...
            wrapper._is_gyra_tool = True
            # Set GYRA_TOOL_IDENTIFIER for backward compatibility with _is_function_tool
            setattr(wrapper, "gyra_tool", True)
