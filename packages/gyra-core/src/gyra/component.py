...
from gyra.util import AppConfig
...
class ComponentType(str, Enum):
    WORKER_MANAGER = "gyra_worker_manager"
    WORKER_MANAGER_FACTORY = "gyra_worker_manager_factory"
    MODEL_CONTROLLER = "gyra_model_controller"
    MODEL_REGISTRY = "gyra_model_registry"
    MODEL_API_SERVER = "gyra_model_api_server"
    MODEL_CACHE_MANAGER = "gyra_model_cache_manager"
    PLUGIN_HUB = "gyra_plugin_hub"
    MULTI_AGENTS = "gyra_multi_agents"
    AGENT_CHAT = "gyra_agent_chat"
    EXECUTOR_DEFAULT = "gyra_thread_pool_default"
    TRACER = "gyra_tracer"
    TRACER_SPAN_STORAGE = "gyra_tracer_span_storage"
    RAG_GRAPH_DEFAULT = "gyra_rag_engine_default"
    AWEL_TRIGGER_MANAGER = "gyra_awel_trigger_manager"
    AWEL_DAG_MANAGER = "gyra_awel_dag_manager"
    UNIFIED_METADATA_DB_MANAGER_FACTORY = "gyra_unified_metadata_db_manager_factory"
    CONNECTOR_MANAGER = "gyra_connector_manager"
    RAG_STORAGE_MANAGER = "gyra_rag_storage_manager"
    AGENT_MANAGER = "gyra_agent_manager"
    LLM_STRATEGY_MANAGER = "gyra_llm_strategy_manager"
    RESOURCE_MANAGER = "gyra_resource_manager"
    VARIABLES_PROVIDER = "gyra_variables_provider"
    FILE_STORAGE_CLIENT = "gyra_file_storage_client"
    VIS_CONVERTER_PACKAGE = "vis_converter_package"
    REASONING_MANAGER = "gyra_reasoning_manager"
    CONTEXT_MANAGER = "gyra_context_manager"
    PERFERMANCE = "perfermance"
    SANDBOX_MANAGER = "sandbox_manager"
    GPTS_MEMORY = "gyra_gpts_memory"
...
class SystemApp(LifeCycle):
    ...
    def _build(self):
        ...
        if not self.app:
            ...
            return
        from gyra.util.fastapi import register_event_handler
