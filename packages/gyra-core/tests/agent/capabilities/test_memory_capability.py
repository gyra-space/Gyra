...
from gyra.agent.capabilities.memory import MemoryCapability, MemoryCapabilityResource
...
def test_facade_wraps_legacy_memory():
    ...
    from gyra.agent.capabilities.memory import register_wrappers
...
async def test_register_capability_and_legacy_provider():
    from gyra.agent.capabilities.facade import ResourceFacade
    from gyra.agent.capabilities.memory import register_capability
