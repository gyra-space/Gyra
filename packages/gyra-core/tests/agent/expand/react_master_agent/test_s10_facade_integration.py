...
from gyra.core.interface.resource.bundle import CacheScope, Contribution, Lifetime, Slot, SystemBlock
...
async def test_sandbox_env_in_system_snapshot():
    ...
    from gyra.agent.capabilities.sandbox.resource import SandboxResource
