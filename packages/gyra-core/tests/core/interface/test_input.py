...
from gyra.core.interface.resource.bundle import CacheControlPoint, CacheScope, Contribution, FrozenBundle, InputBundle, Lifetime, Slot
# 构造辅助
# --------------------------------------------------------------------------- #
...
def _bundle_scopes(*scopes):
    from gyra.core.interface.resource.bundle import InputBundle, CacheScope
...
def test_to_legacy_system_message_default_separator():
    ...
    from gyra.core.interface.resource.bundle import CacheScope
