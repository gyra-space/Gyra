...
from gyra.core.interface.resource.data_requirement import DataRequirement, InjectionMode, SMALL_DB_THRESHOLD, MEDIUM_DB_THRESHOLD, injection_mode_for_table_count
