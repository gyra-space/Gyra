...
try:
    ...
    print(f"GYRA_HOME: {gyra_home}")

    config_file = os.path.join(gyra_home, "gyra.json")
...
try:
    ...
    from gyra_ext.datasource.rdbms.conn_oracle import _init_thick_mode, _thick_mode_initialized
