...
-- ============ 新建表 ============
CREATE TABLE IF NOT EXISTS `gyra_serve_agent/chat` ( `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Auto increment id', `gmt_create` DATETIME NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record creation time', `gmt_modified` DATETIME NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Record update time', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- 表: gyra_serve_ecp_resolution_cache
...
-- 表: gyra_serve_ecp_semantic_edge
...
-- 表: gyra_serve_ecp_semantic_object
...
-- 表: gyra_serve_ecp_workspace_config
...
-- 表: server_app_asset_maturity_log
...
-- 表: server_app_playbook_evolution_proposal
...
-- 表: server_app_workspace_agent_maturity
...
-- 表: server_app_workspace_agent_role
...
-- 表: server_app_workspace_asset_version
...
-- 表: server_app_workspace_conv_link
...
-- 表: server_app_workspace_inbox_item
...
-- 表: server_app_workspace_resource
