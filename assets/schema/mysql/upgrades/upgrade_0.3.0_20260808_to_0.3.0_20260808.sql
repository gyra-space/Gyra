...
-- Source schema generated: 2026-08-08T12:30:25.350388
-- Generated: 2026-08-08T12:30:25.352378
-- ============================================================
...
ALTER TABLE `gyra_serve_cron_job` ADD COLUMN `last_duration_ms` INT NULL COMMENT 'Last run duration in ms';
...
ALTER TABLE `gyra_serve_cron_job` ADD COLUMN `running_at_ms` INT NULL COMMENT 'Current run start time in ms';
...
ALTER TABLE `gyra_serve_cron_job` ADD COLUMN `last_run_at_ms` INT NULL COMMENT 'Last run time in ms';
...
ALTER TABLE `gyra_serve_cron_job` ADD COLUMN `id` VARCHAR(64) NOT NULL AUTO_INCREMENT COMMENT 'Job unique identifier';
...
ALTER TABLE `gyra_serve_cron_job` ADD COLUMN `next_run_at_ms` INT NULL COMMENT 'Next run time in ms';
...
ALTER TABLE `gyra_serve_cron_job_log` ADD COLUMN `run_at_ms` INT NOT NULL COMMENT 'Run start time in ms';
ALTER TABLE `gyra_serve_cron_job_log` ADD COLUMN `id` VARCHAR(64) NOT NULL AUTO_INCREMENT COMMENT 'Log unique identifier';
...
ALTER TABLE `gyra_serve_cron_job_log` ADD COLUMN `duration_ms` INT NULL COMMENT 'Execution duration in ms';
