-- ============================================================
-- Incremental DDL Script for Gyra
...
-- Table: gyra_cluster_registry_instance
ALTER TABLE `gyra_cluster_registry_instance` MODIFY COLUMN `weight` FLOAT NULL COMMENT 'Weight of the model';
...
-- DROP TABLE IF EXISTS `gyra_serve_channel_config`;
-- DROP TABLE IF EXISTS `gyra_serve_config`;
-- DROP TABLE IF EXISTS `gyra_serve_cron_job`;
-- DROP TABLE IF EXISTS `gyra_serve_file`;
-- DROP TABLE IF EXISTS `gyra_serve_flow`;
-- DROP TABLE IF EXISTS `gyra_serve_mcp`;
-- DROP TABLE IF EXISTS `gyra_serve_model`;
-- DROP TABLE IF EXISTS `gyra_serve_variables`;
