...
-- Version: 0.6.0
-- Generated: 2026-09-06T22:29:11.389411
-- ============================================================
...
CREATE INDEX "ix_server_app_trigger_source_target_app_code" ON "server_app_trigger_source" ("target_app_code");
...
CREATE TABLE IF NOT EXISTS "skill_sync_task" (
  ...
  "synced_skills_count" INTEGER DEFAULT 0,
  "skill_codes" TEXT,
  "error_msg" TEXT,
  "error_details" TEXT,
...
CREATE TABLE IF NOT EXISTS "server_app_workspace_expert" (
  ...
  "gmt_modified" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY ("id"),
  CONSTRAINT "uk_workspace_expert" UNIQUE ("workspace_id", "app_code")
);
...
CREATE TABLE IF NOT EXISTS "server_app_workspace_expert_equipment" (
  ...
  "gmt_modified" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY ("id"),
  CONSTRAINT "uk_workspace_expert_equipment" UNIQUE ("expert_id", "resource_type", "resource_ref")
);
...
CREATE TABLE IF NOT EXISTS "recommend_question" (
  ...
  "gmt_modified" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  "question" TEXT,
  "valid" VARCHAR(31) DEFAULT 1,
  "params" TEXT,
  "chat_mode" VARCHAR(31),
  "is_hot_question" VARCHAR(10) DEFAULT 0,
  PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "gyra_serve_ecp_semantic_alignment" (
  ...
  "gmt_modify" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY ("id"),
  CONSTRAINT "uk_ecp_alignment_key" UNIQUE ("workspace_id", "slug", "entity_name", "object_id")
);
