...
-- Source schema generated: 2026-08-08T20:17:10.827760
-- Generated: 2026-08-08T20:17:10.831160
-- ============================================================
...
ALTER TABLE "gyra_serve_cron_job" ADD COLUMN "last_run_at_ms" INTEGER;
...
ALTER TABLE "gyra_serve_cron_job" ADD COLUMN "last_duration_ms" INTEGER;
...
ALTER TABLE "gyra_serve_cron_job" ADD COLUMN "next_run_at_ms" INTEGER;
...
ALTER TABLE "gyra_serve_cron_job" ADD COLUMN "running_at_ms" INTEGER;
...
ALTER TABLE "gyra_serve_cron_job_log" ADD COLUMN "duration_ms" INTEGER;
...
ALTER TABLE "gyra_serve_cron_job_log" ADD COLUMN "run_at_ms" INTEGER NOT NULL;
