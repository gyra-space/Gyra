...
-- ============ 新建表 ============
CREATE TABLE IF NOT EXISTS "gyra_serve_agent/chat" ( "id" SERIAL, "gmt_create" TIMESTAMP DEFAULT CURRENT_TIMESTAMP, "gmt_modified" TIMESTAMP DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id") );
