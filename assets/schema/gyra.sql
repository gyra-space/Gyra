-- You can change `gyra` to your actual metadata database name in your `.env` file
-- eg. `LOCAL_DB_NAME=gyra`

CREATE
DATABASE IF NOT EXISTS gyra;
use gyra;
