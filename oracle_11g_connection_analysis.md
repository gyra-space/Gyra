...
- `packages/gyra-serve/src/gyra_serve/agent/capabilities/db/capability.py:203-232` - prepare() 方法
- `packages/gyra-serve/src/gyra_serve/agent/resource/datasource.py:133-138` - 旧版本逻辑
