#!/usr/bin/env python3
"""
DDL Generator for Gyra Project - Enterprise-grade multi-database DDL generator.
...
class MySQLAdapter(DialectAdapter):
    ...
    def generate_full_ddl(self, schema: UnifiedSchema) -> List[str]:
        ...
        # Header
        statements.append("-- ============================================================")
        statements.append("-- MySQL DDL Script for Gyra")
    ...
    def generate_incremental_ddl(
        ...
        # Header
        statements.append("-- ============================================================")
        statements.append("-- MySQL Incremental DDL Script for Gyra")
...
class PostgreSQLAdapter(DialectAdapter):
    ...
    def generate_full_ddl(self, schema: UnifiedSchema) -> List[str]:
        ...
        # Header
        statements.append("-- ============================================================")
        statements.append("-- PostgreSQL DDL Script for Gyra")
        statements.append(f"-- Version: {schema.version}")
        statements.append(f"-- Generated: {schema.generated_at}")
        statements.append("-- ============================================================")
        statements.append("")
    ...
    def generate_incremental_ddl(
        ...
        # Header
        statements.append("-- ============================================================")
        statements.append("-- PostgreSQL Incremental DDL Script for Gyra")
        statements.append(f"-- Upgrade from {diff.old_version} to {diff.new_version}")
        if diff.old_generated:
            statements.append(f"-- Source schema generated: {diff.old_generated}")
        statements.append(f"-- Generated: {diff.new_generated}")
...
class DDLGenerator:
    ...
    def generate_all_dialects(self, output_dir: Path) -> Dict[str, Path]:
        ...
        for dialect in self.adapters.keys():
            ...
            output_file = dialect_dir / "gyra.sql"
...
def discover_metadata() -> MetaData:
    ...
    package_roots = [
        Path(__file__).parent.parent.parent / "packages" / "gyra-core" / "src",
        Path(__file__).parent.parent.parent / "packages" / "gyra-serve" / "src",
    ]
