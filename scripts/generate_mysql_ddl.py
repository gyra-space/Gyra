...
def find_model_files(root_dir):
    ...
    search_dirs = [
        'packages/gyra-core/src/gyra/storage',
        'packages/gyra-core/src/gyra/model',
...
def generate_incremental_ddl(
    ...
    statements.append("-- ============================================================")
    statements.append("-- Incremental DDL Script for Gyra")
...
def main():
    ...
    print("=" * 80)
    print("MySQL DDL Generation Script for Gyra Project")
    print("=" * 80)
    print()
    ...
    full_ddl_file = schema_dir / "gyra.sql"
    ...
    # Generate full DDL
    ddl_statements = []
    ddl_statements.append("-- You can change `gyra` to your actual metadata database name in your `.env` file")
    ddl_statements.append("-- eg. `LOCAL_DB_NAME=gyra`")
    ddl_statements.append("")
    ddl_statements.append("CREATE")
    ddl_statements.append("DATABASE IF NOT EXISTS gyra;")
    ddl_statements.append("use gyra;")
    ddl_statements.append("")
    ddl_statements.append("-- ============================================================")
    ddl_statements.append("-- MySQL DDL Script for Gyra")
