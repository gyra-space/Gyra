...
import { App, Button, Modal, Tag, Pagination, PaginationProps, Tabs, Spin } from 'antd';
              ...
              children:
                configLoading ? (
                  ...
                  <div className='model-config-panel'>
                    <LLMSettingsSection config={config} onChange={loadConfig} />
                  </div>
                ) : null,
            },
            {
              key: 'status',
              label: t('model_status_tab'),
              children: (
                <>
