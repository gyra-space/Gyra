      ...
      >
        <Avatar
          ...
          icon={
            ...
            type === 'mcp' ? <ApiOutlined className="text-purple-500" /> : undefined
          }
        >
          {type === 'skill' && <span className="text-blue-500 text-lg font-semibold">{resource.name ? resource.name.charAt(0).toUpperCase() : 'S'}</span>}
        </Avatar>
