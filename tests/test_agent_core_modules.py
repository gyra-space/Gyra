...
sys.path.insert(0, os.path.join(_project_root, "packages/gyra-core/src"))
sys.path.insert(0, os.path.join(_project_root, "packages/gyra-ext/src"))
...
def test_base_agent_permission_integration():
    ...
    import gyra.agent.core.base_agent as base_agent_module
