...
sys.path.insert(0, str(_project_root / "packages/gyra-core/src"))
...
def check_base_agent_code():
    ...
    base_agent_path = (
        _project_root / "packages/gyra-core/src/gyra/agent/core/base_agent.py"
    )
...
def suggest_fix():
    ...
    print("""
## File: packages/gyra-core/src/gyra/agent/core/base_agent.py
