...
def check_database_skill():
    ...
    db_path = Path("pilot/meta_data/gyra.db")
...
def check_app_config(skill_code):
    ...
    config_path = Path(
        "packages/gyra-serve/src/gyra_serve/building/app/service/gyra_app_define/rca_openrca_app.json"
    )
...
def check_skill_files():
    ...
    skill_paths = [
        ...
        Path("pilot/data/skill/open-rca-diagnosis-2-0-gyra-c5b0e208"),
    ]
...
def main():
    print("Gyra ReActMasterV2 Diagnostic Tool")
