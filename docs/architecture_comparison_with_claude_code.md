# Claude Code vs Gyra 架构深度对比分析报告
...
class AgentManager(BaseComponent):
    ...
    def after_start():
        """启动后自动扫描"""
        scan_agents("gyra.agent.expand")
        scan_agents("gyra_ext.agent.agents")
```
...
**Gyra** 代表了**企业级**AI代理框架设计理念：
- 架构完善，功能全面
- 安全可控，生产就绪
- 适合企业级复杂场景

两者在AI代理领域各有优势，可以根据具体需求选择。对于需要快速上手的个人开发者，推荐Claude Code；对于需要企业级特性、复杂任务编排的场景，推荐Gyra。
