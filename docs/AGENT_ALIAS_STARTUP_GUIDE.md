...
```
[INFO] register_agent:<class 'gyra.agent.expand.react_master_agent.react_master_agent.ReActMasterAgent'>
[INFO] [AgentManager] Auto-registered aliases for BAIZE: ['ReActMasterV2', 'ReActMaster']
```

**日志位置**: 通常是 `logs/gyra.log` 或控制台输出
...
# 导入并检查
from gyra.agent.core.agent_alias import AgentAliasManager
...
```bash
# 检查ProfileConfig
grep -n "aliases:" packages/gyra-core/src/gyra/agent/core/profile/base.py

# 检查ReActMasterAgent
grep -n "aliases=" packages/gyra-core/src/gyra/agent/expand/react_master_agent/react_master_agent.py

# 检查AgentManager
grep -n "Auto-registered aliases" packages/gyra-core/src/gyra/agent/core/agent_manage.py
```
...
```
2024-01-15 10:00:00 [INFO] register_agent:<class 'gyra.agent.expand.react_master_agent.react_master_agent.ReActMasterAgent'>
2024-01-15 10:00:00 [INFO] [AgentManager] Auto-registered aliases for BAIZE: ['ReActMasterV2', 'ReActMaster']
2024-01-15 10:00:00 [INFO] register_agent:<class 'gyra.agent.expand.other_agent.OtherAgent'>
...
```
