...
const config = {
  ...
  organizationName: 'gyra-ai', // Usually your GitHub org/user name.
  projectName: 'Gyra', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/gyra-ai/gyra',
            position: 'right',
            className: 'header-github-link',
          },
          {
            href: 'https://huggingface.co/gyra',
            position: 'right',
            label: "HuggingFace",
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Gyra-AI`,
      },
      prism: {
