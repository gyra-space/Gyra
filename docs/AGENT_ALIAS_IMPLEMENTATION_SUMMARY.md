...
**文件位置**: `packages/gyra-core/src/gyra/agent/core/agent_alias.py`
...
```python
# 导入
from gyra.agent.core.agent_alias import AgentAliasConfig, AgentNameResolver
...
### 注册新别名
```python
from gyra.agent.core.agent_alias import AgentAliasConfig
...
# 方式2: 使用便捷工具
from gyra.agent.core.agent_alias import AgentNameResolver
