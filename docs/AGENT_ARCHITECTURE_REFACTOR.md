...
基于对opencode (111k stars) 和 openclaw (230k stars) 两大顶级开源项目的深度对比分析,本文档提出了Gyra Agent系统的全面重构方案。方案涵盖Agent构建、运行时、可视化、用户交互、工具系统、流程控制、循环控制等8大核心领域,旨在构建一个生产级、可扩展、高可用的AI Agent平台。
...
```python
# packages/gyra-serve/src/gyra_serve/agent/core/agent_info.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/core/agent_base.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/gateway/gateway.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/core/agent_executor.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/tools/tool_base.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/tools/bash_tool.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/skills/skill_base.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/visualization/progress.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/visualization/canvas.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/memory/memory_simple.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/channels/channel_base.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/sandbox/sandbox.py
...
```python
# packages/gyra-serve/src/gyra_serve/agent/config/config_loader.py
...
重构完成后,Gyra将具备生产级AI Agent平台的核心能力,为后续功能扩展奠定坚实基础。